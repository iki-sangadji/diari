                            ...
                            <div class="card col-lg-9">
                                ...
                                <div class="card-body card-block">
                                        ...
                                        <div class="card-footer" >
                                            <button type="button" class="btn btn-success" onclick="nextQuestion({{$i}})" onclick="check({{$gejalas[$i]->nama}});">Ya</button>
                                            <button type="button" class="btn btn-danger" onclick="nextQuestion({{$i}})">Tidak</button>
                                            <ul class="ks-cboxtags" style="display : none;">
                                                <li><input type="checkbox" id="{{$gejalas[$i]->nama}}" name="gejala[]" value="{{$gejalas[$i]->nama}}" ><label for="{{$gejalas[$i]->nama}}">Ya</label></li>
